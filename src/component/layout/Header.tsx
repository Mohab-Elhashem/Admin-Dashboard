...
export default function Header({  onToggleSidebar }: headerProps) {
    return (
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 sm:px-6 px-2 py-4 overflow-hidden">
            <div className="flex justify-between items-center">
                ...
                {/* right section */}
                <div className="flex items-center sm:gap-x-3 gap-0">
                    {/* quic action */}
